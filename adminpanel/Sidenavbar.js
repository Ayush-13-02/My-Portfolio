...
function Sidenavbar() {
    return (
        <div className="z-20 overflow-y-auto scrolling-touch lg:sticky scrollbar flex flex-col items-center w-60 h-screen overflow-hidden text-gray-400 bg-gray-900 rounded">
